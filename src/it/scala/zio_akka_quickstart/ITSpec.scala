...
import zio_akka_quickstart.infrastructure.{ Postgres, SlickItemRepository }
import zio_akka_quickstart.infrastructure.Postgres.SchemaAwarePostgresContainer
...
import zio_akka_quickstart.infrastructure.EventSubscriber
